...
- Show Manager registration at `/register/show-manager` and Show Secretary registration at `/register/show-secretary` collect a name, an email and a password, and nothing else. Both redirect to `/welcome` once signed in.
