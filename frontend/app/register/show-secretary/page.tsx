    ...
    <main className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: '#faf7f2' }}>
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold mt-3" style={{ color: '#2c1810' }}>Show Secretary Registration</h1>
          <p className="text-sm mt-1" style={{ color: '#8b7355' }}>Create an account to manage shows and enter results</p>
        </div>
